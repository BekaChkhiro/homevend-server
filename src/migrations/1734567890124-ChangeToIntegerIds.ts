...
export class ChangeToIntegerIds1734567890124 implements MigrationInterface {
    name = 'ChangeToIntegerIds1734567890124'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Drop foreign key constraint first
        await queryRunner.query(`ALTER TABLE "properties" DROP CONSTRAINT "FK_PROPERTY_USER"`);
        
        // Drop existing tables (since we're changing primary key types)
        ...
        await queryRunner.query(`CREATE TYPE "public"."properties_status_enum" AS ENUM('active', 'inactive', 'pending', 'sold')`);
        ...
        // Create properties table with integer foreign key
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // Recreate original schema with UUID
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('user', 'admin')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_status_enum" AS ENUM('active', 'inactive', 'pending', 'sold')`);
